...
(function make_xlsx (XLSX) {
    ...
    function _write (cfb, options) {
      ...
      var L = (function (cfb) {
        ...
        for (var i = 0; i < cfb.FileIndex.length; ++i) {
          ...
          if (flen === 0) {} else if (flen < 0x1000) mini_size += (flen + 0x3F) >> 6
  ...
  function aoa_to_sheet (data, opts) {
    ...
    for (var R = 0; R != data.length; ++R) {
      for (var C = 0; C != data[R].length; ++C) {
        ...
        if (cell.v === null) { if (cell.f) cell.t = 'n'; else if (!o.cellStubs) continue; else cell.t = 'z' } else if (typeof cell.v === 'number') cell.t = 'n'
      ...
      for (; ri !== records.length; ++ri) {
        ...
        if (rstr.length > 0) {
          switch (RT) {
            ...
            case 'P':
              if (record[1].charAt(0) == 'P') { formats.push(rstr.substr(3).replace(/;;/g, ';')) }
              break
            case 'C':
  ...
  var PRN = (function () {
    ...
    function dsv_to_sheet_str (str, opts) {
      ...
      if (str.substr(0, 4) == 'sep=' && str.charCodeAt(5) == 10) { sep = str.charAt(4); str = str.substr(6) } else sep = guess_sep(str.substr(0, 1024))
      var R = 0, C = 0, v = 0
      ...
      function finish_cell () {
        ...
        if (s.length === 0) cell.t = 'z'
          ...
          if (s.charCodeAt(1) == 0x22 && s.charCodeAt(s.length - 1) == 0x22) { cell.t = 's'; cell.v = s.slice(2, -1).replace(/""/g, '"') } else if (fuzzyfmla(s)) { cell.t = 'n'; cell.f = s.substr(1) } else { cell.t = 's'; cell.v = s }
  ...
  function write_comments_vml (rId, comments) {
    ...
    comments.map(function (x) { return decode_cell(x[0]) }).forEach(function (c, i) {
      o = o.concat([
        '<v:shape' + wxt_helper({
...
*/
  ...
  function readSync (data, opts) {
    ...
    if (n[0] < 0x20 || n[0] > 0x7F) throw new Error('Unsupported file ' + n.join('|'))
